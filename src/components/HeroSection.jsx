      ...
      <div className={"container relative"} ref={parallaxRef}>
        ...
        >
          <h1 className={"h1 mb-6"}>
            Explore the Possibles of &nbsp;AI&nbsp; Chatting with{" "}
          ...
          <p className={"body-1 max-w-3xl mx-auto mb-6 text-n-2 lg:mb-8"}>
            Unleashed the power of AI within Brainwave.{" "}
          </p>
            ...
            <div className={"relative bg-n-8 rounded-[1rem]"}>
              ...
              >
                <img
                  src={robot}
                  className={
                    "w-full scale-[1.7] translate-y-[8%] md:scale-100 md:-translate-y-[10%] lg:-translate-y-[23%]"
                  }
                  width={1024}
                  height={490}
                  alt="AI"
